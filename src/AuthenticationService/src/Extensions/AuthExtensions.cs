...
namespace AuthenticationService.Extensions
{
    public static class AuthExtensions
    {
        ...
        private const string RegistryName = "auth";
         public static IInitializationContainer AddJwt(this IInitializationContainer container, string sectionName = SectionName,
            Action<JwtBearerOptions> optionsFactory = null)
        {
            ...
            var options = container.GetOptions<JwtOptions>(sectionName);
            return container.AddJwt(options, optionsFactory);
        }

        private static IInitializationContainer AddJwt(this IInitializationContainer container, JwtOptions options, 
            Action<JwtBearerOptions> optionsFactory = null)
        {
            ...
            container.Services.AddSingleton<IJwtHandler, JwtHandler>();
            container.Services.AddSingleton<IAccessTokenService, AccessTokenService>();
            container.Services.AddTransient<AccessTokenValidatorMiddleware>();

            if (options.AuthenticationDisabled)
            {
                container.Services.AddSingleton<IPolicyEvaluator, DisabledAuthenticationPolicyEvaluator>();
            }
            ...
            container.Services.AddSingleton(tokenValidationParameters);
