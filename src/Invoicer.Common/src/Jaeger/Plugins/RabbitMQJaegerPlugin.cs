...
namespace Invoicer.Common.Jaeger.Plugins
{
    internal sealed class RabbitMQJaegerPlugin : RabbitMqPlugin
    {
        private readonly ITracer _tracer;
        private readonly string _spanContextHeader;

        public RabbitMQJaegerPlugin(ITracer tracer, RabbitMqOptions options)
        {
            _tracer = tracer;
