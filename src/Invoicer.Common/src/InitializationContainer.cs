...
namespace Invoicer.Common
{
    public class InitializationContainer : IInitializationContainer
    {
        ...
        IServiceCollection IInitializationContainer.Services => _services;

        private InitializationContainer(IServiceCollection services)
        {
        ...
        public static IInitializationContainer Create(IServiceCollection services)
            => new InitializationContainer(services);
